...
void loop()
{
  if (air_hum(10) <= 98)
  {
    ...
    {
      if (moisture_sen(10) >= 90 && temp_sen(10) <= 30 && light_sen(10) == 1)
      {
        buzz_on(1);
        delay(100);
        buzz_on(0);
        ...
        while (moisture_sen(10) >= 90 && temp_sen(10) <= 30 && light_sen(10) == 1 && gas_sen(10) == 0);
      }
      ...
      else
      {
        ...
        while (moisture_sen(10) <= 90 && temp_sen(10) >= 30 && light_sen(10) == 0);
      }
    }
  }
...
float moisture_sen(int n)      //function to sense water moisture
{
  ...
  else if (so < 1007 && so >= 972.5)
  {
    return so / 55.5;
  }
  else if (so < 972.5 && so >= 725)
  {
    return so / 22.3;
  }
 else if (so < 725 && so >= 387.5)
  {
    return so / 7.04;
  }
  else if (so < 387.5 && so >= 272)
  {
    return so / 3.2;
  }
  else if (so < 272 && so >= 264)
  {
    return so / 2.7;
  }
  else
